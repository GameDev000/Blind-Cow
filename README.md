...
<ul>
  ...
  <li>השחקנים שבורחים יכולים לאסוף מטבעות ולהשתמש ביכולות מיוחדות כגון:
    <ul>
      ...
      <li>שיפור מהירות ועוד.</li>
    </ul>
  </li>
  <li>כאשר השחקן הוא הפרה – הוא מקבל ניקוד על כל שחקן שנתפס, כאשר השחקן הוא בורח הוא יכול לקבל ניקוד מאיסוף מטבעות או מהימלטות מהפרה עד סוף המשחק.</li>
  <li>לשחקן בתפקיד הפרה יש אפשרות להשתמש בפקודה מיוחדת:
    <em>“כווולם השמיעו קול!”</em>  
  כל השחקנים חייבים לענות: <strong>“קוקוריקו תרנגול!”</strong> 
  או יכולת הצצה למשך 3 שניות ללא כיסוי עיניים.
  </li>
